    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <input type="text" id="price" value="{{$product->price}}" name="price" required="required" class="form-control ">
                </div>
            </div>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <textarea id="message" value="" required="required" class="form-control" name="product_desc" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.." data-parsley-validation-threshold="10">
