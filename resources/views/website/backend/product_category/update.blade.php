...
@section('content')
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br>
                <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="POST" action="{{route('product_category.update',$productcategory->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" value="{{$productcategory->brand_name}}" id="brand_name" name="brand_name" required="required" class="form-control ">
                        </div>
                    </div>
                    {{-- <div class="item form-group">
